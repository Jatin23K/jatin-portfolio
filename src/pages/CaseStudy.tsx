      ...
      {detail ? (
        <>
            ...
            <article className="card-shell">
              ...
              <ul className="mt-3 space-y-2">
                {detail.approach.map((item) => (
                  <li key={item} className="text-sm text-text-dim">
                    - {item}
                  </li>
                ))}
              </ul>
          ...
          <section className="mt-8 grid gap-6 lg:grid-cols-2">
            ...
            <article className="card-shell">
              <p className="mono-label">Risks and Controls</p>
              <ul className="mt-3 space-y-2">
          ...
          <section className="mt-8 card-shell border-t-2 border-t-accent2">
        ...
        <section className="mt-8 card-shell">
          ...
          <p className="mt-3 text-sm text-text-dim">
            This case study is scaffolded. Add detailed execution notes in `src/data/projectDetails.ts` for this
            project ID to publish the full narrative.
          </p>
        </section>
      )}
