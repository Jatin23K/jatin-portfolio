...
export const projects: Project[] = [
  ...
  {
    id: 'tiktok-claim-classification',
    tier: 2,
    typeBadge: 'Pure Data Science',
    title: 'TikTok Trust & Safety Triage',
    oneLineOutcome:
      'Inferential statistics & supervised triage pipeline prioritizing viral claim moderation — powered by Welch’s t-test (p = 2.61e-120) and a 0.9987 ROC-AUC classifier with zero target leakage.',
    primaryKpi: "Welch's t-Statistic",
    kpiDelta: '-25.50 (p < 1e-100)',
    tagline: 'Algorithmic claim triage and creator verification dynamics at TikTok scale',
    problem:
      'TikTok moderators process millions of user reports daily with limited review capacity. Conventional assumptions assumed verified creators drive higher view velocity, risking triage misallocation.',
    solution:
      'Conducted two-sample Welch\'s t-test (df = 1,571.16) disproving the verification reach assumption — proving unverified accounts generate 2.91x higher mean views (265.7k vs 91.4k). Engineered leak-free dual-model triage: Random Forest claim detector (0.9987 ROC-AUC) and regularized logistic regression quantifying verification log-odds with normalized engagement interaction ratios.',
    impact:
      'Established empirical proof (p = 2.61e-120) for reprioritizing moderation queues toward high-velocity unverified claims. Delivered 0.9969 F1 triage accuracy to automate low-risk opinion bypass while arresting viral misinformation.',
    tech: ['Python', 'scipy.stats', 'scikit-learn', 'Pandas', 'NumPy', 'Welch t-Test', 'Random Forest', 'Logistic Regression'],
    status: 'shipped',
    metrics: [
      { label: 'Claim ROC-AUC', value: '0.9987' },
      { label: "Welch's t-Test", value: 'p = 2.61e-120' },
      { label: 'Unverified View Lift', value: '2.91x' },
    ],
    links: {
      demo: 'https://github.com/Jatin23K/tiktok-claims-triage',
      github: 'https://github.com/Jatin23K/tiktok-claims-triage',
    },
    order: 1,
    isVisible: true,
    caseStudyPublished: true,
    targetMilestone: 'Shipped',
    featured: false,
  },
]
